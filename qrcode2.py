...
def generate_qr(staff_id, staff_name, department, email, filename="staff_qr.png"):
    """Generates a QR code with staff details and saves it as an image."""
    data = f"Staff ID: {staff_id}\nName: {staff_name}\nDepartment: {department}\nEmail: {email}"
    qr = qrcode.QRCode(
        version=1,
